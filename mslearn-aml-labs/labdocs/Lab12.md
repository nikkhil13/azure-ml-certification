...
3. In the Jupyter home page, in the **Users/mslearn-aml-labs** folder, open the **12-Monitoring_a_model.ipynb** notebook. Then read the notes in the notebook, running each code cell in turn.
